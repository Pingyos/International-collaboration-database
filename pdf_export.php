...
if ($count > 0) {
	...
	<table>
		...
		<tr>
			<td><b>Date MOU(D/M/Y) : </b>' . $inv_mst_data_row['signed'] . ' </td>
			<td><b>Expired: </b>' . $inv_mst_data_row['expired'] . ' </td>
		</tr>
		...
		<tr>
			<td><b>Start : </b>' . $inv_mst_data_row['date_s'] . ' </td>
			<td><b>End: </b>' . $inv_mst_data_row['date_e'] . ' </td>
		</tr>
